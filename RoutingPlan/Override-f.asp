...
<iframe FRAMEBORDER="0" SRC="Override_Layout_Top.asp?OPID=<%= Request.QueryString("OPID") %>&AHSID=<%= Request.QueryString("AHSID") %>" SCROLLING=NO ID="TOPAREA" WIDTH="1" HEIGHT="1"></iframe>
<iframe FRAMEBORDER="0" SRC="Override_Layout_Bottom.asp?OPID=<%= Request.QueryString("OPID") %>&AHSID=<%= Request.QueryString("AHSID") %>" SCROLLING="auto" ID="LAYOUTAREA" WIDTH="1" HEIGHT="1"></iframe>
