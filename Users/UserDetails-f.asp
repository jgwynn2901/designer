...
<meta name="VI60_defaultClientScript" content="VBScript">
   ...
   <frameset CanDocUnloadNowInf="YES" ROWS="0,0,*" border="0" framespacing="0">
   		<frame NAME="hiddenPage" SRC="ABOUT:BLANK" scrolling="No" noresize FRAMEBORDER="no" BORDER="0" framespacing="0">
        <frame src="USRLKP.asp" id="userLookup" name="userLookup" marginwidth="0" marginheight="0" scrolling="no" noresize>
        <frame NAME="WORKAREA" SRC="UserDetails.asp?<%=Request.QueryString%>" SCROLLING="NO" FRAMEBORDER="no" NORESIZE BORDER="0" framespacing="0">
	</frameset>
