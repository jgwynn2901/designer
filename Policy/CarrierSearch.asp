...
Sub BtnClear_onclick()
	...
	document.all.SearchCarrierNumber.value = ""
End Sub

Sub BtnSearch_onclick()
	'If document.all.SearchCID.value = "" And document.all.SearchName.value = "" And _
...
If document.all.SearchCID.value <> "" And document.all.SearchName.value <> "" And _
	...
	document.all.SearchCarrierNumber.value <> ""Then
...
Sub PostTo(strURL)
	...
	curCID = Parent.frames("WORKAREA").GetCID
	temp = Split(curCID, "||")
	If UBound(temp) >= 0 Then 
		document.all.CID.value = temp(0)
	Else		
		document.all.CID.value = ""
	End If
	FrmSearch.action = "CarrierDetails-f.asp"
...
<TR><TD CLASS=GrpLabel WIDTH="134" HEIGHT=10><NOBR>&nbsp&#187 Carrier Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="../Images/HelpIcon2.gif" STYLE="CURSOR:HAND" align=absmiddle title=Help OnClick='LaunchHelp("Welcome.htm")'></TD>
...
<td>
	...
	<tr>
	<Tr>
		<Td CLASS="LABEL">Carrier Number:<br><input CLASS="LABEL" tabindex=1 TYPE="TEXT" MAXLENGTH="30" NAME="SearchCarrierNumber" VALUE="<%=Request.QueryString("CARRIER_NUMBER")%>"></td>
	...
	<tr>
		<td CLASS="LABEL">Carrier ID:<br><input CLASS="LABEL" TYPE="TEXT" tabindex=3 NAME="SearchCID" VALUE="<%=Request.QueryString("SearchCID")%>"></td>
