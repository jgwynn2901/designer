...
Function GetXREFID
	GetXREFID= frames("WORKAREA").GetXREFID
End Function
...
<meta name="VI60_defaultClientScript" content="VBScript">
   ...
   <frameset CanDocUnloadNowInf="YES" ROWS="0,*" border="0" framespacing="0">
        ...
        <frame NAME="WORKAREA" SRC="CoverageDetails.asp?<%=Request.QueryString%>" scrolling=auto FRAMEBORDER="no" NORESIZE BORDER="0" framespacing="0">
	</frameset>
