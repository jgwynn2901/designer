...
Sub BtnClear_onclick()
	document.all.SearchCOID.value = ""
	document.all.SearchName.value = ""
	document.all.SearchsType.value = ""
	document.all.SearchDescription.value = ""
End Sub

Sub BtnSearch_onclick()
	'If document.all.SearchCOID.value = "" And document.all.SearchName.value = "" And _
	'document.all.SearchsType.value = "" And document.all.SearchDescription.value = "" Then
...
Sub PostTo(strURL)
	...
	curCOID = Parent.frames("WORKAREA").GetCOID
	temp = Split(curCOID, "||")
	If UBound(temp) >= 0 Then 
		document.all.COID.value = temp(0)
	Else		
		document.all.COID.value = ""
	End If
	FrmSearch.action = "ContactDetails-f.asp"
...
<TR><TD CLASS=GrpLabel WIDTH="134" HEIGHT=10><NOBR>&nbsp&#187 Contact Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="../Images/HelpIcon2.gif" STYLE="CURSOR:HAND" align=absmiddle title=Help OnClick='LaunchHelp("Welcome.htm")'></TD>
...
<form Name="FrmSearch" METHOD="GET" ACTION="ContactSearchResults.asp" TARGET="WORKAREA">
...
<td>
	...
	<tr>
	<tr>
	<td CLASS="LABEL">Name:<br><input CLASS="LABEL" tabindex=1 TYPE="TEXT" NAME="SearchName" size=40 VALUE="<%=Request.QueryString("SearchName")%>"></td>
	<td CLASS="LABEL">Type:<br><input CLASS="LABEL" tabindex=2 TYPE="TEXT" NAME="SearchsType" size=40 VALUE="<%=Request.QueryString("SearchsType")%>"></td>
	</TR>
	<TR>
	<td CLASS="LABEL" COLSPAN=2>Description:<br><input tabindex=4 SIZE=82 CLASS="LABEL" TYPE="TEXT" NAME="SearchDescription" VALUE="<%=Request.QueryString("SearchDescription")%>"></td>
	</TR>
	<TR>
	<td CLASS="LABEL">Contact ID:<br><input tabindex=4 SIZE=10 MAXLENGTH=10 CLASS="LABEL" TYPE="TEXT" NAME="SearchCOID" VALUE="<%=Request.QueryString("SearchCOID")%>"></td>
	</TR>
	</table>
</td>
