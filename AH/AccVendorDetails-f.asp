...
Function GetBIDName
	GetBIDName = frames("WORKAREA").GetBIDName
End Function
...
<meta name="VI60_defaultClientScript" content="VBScript">
   ...
   <frameset  CanDocUnloadNowInf= "YES" ROWS="0,*" border="0" framespacing="0">
        ...
        <frame NAME="WORKAREA" SRC="AccVendorDetails.asp?<%=Request.QueryString%>"   SCROLLING="AUTO" FRAMEBORDER="no" NORESIZE BORDER="0" framespacing="0">
	</frameset>
</html>