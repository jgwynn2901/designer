...
Sub BtnFind_onclick
	If TxtName.Value <> "" OR TxtCaption.Value <> "" OR TxtDescription.value <> "" OR TxtHelpString.value <> "" Then
		...
		Parent.frames("WORK").location.href = "AttributeMaint.asp?" & Clause
	Else
...
Sub TreeView1_NodeDblClicked( NodeType, NodeKey, NodeText , IsLoaded , Shift )
 	Parent.frames("WORK").location.href = "AttributeMaint2.asp?" &  NodeKey
End Sub
...
<TABLE>
<TR>
<TD COLSPAN=4 CLASS=LABEL>Help String:<BR><INPUT TYPE=TEXT NAME="TxtHelpString" SIZE=85 CLASS=LABEL VALUE="<%= Request.QueryString("TxtHelpString") %>"></TD>
</TR>
</TABLE>
<TABLE>
<TR>
