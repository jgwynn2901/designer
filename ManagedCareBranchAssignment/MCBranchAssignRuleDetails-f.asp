...
{
<%	if MODE <> "RO" then %>	
	b_IsRequired = frames("WORKAREA").f_CheckRequire();
	if (b_IsRequired == true)
	{
		alert("Each Branch Assignment Type must have at least 1 Branch Assignment Rule.");
		return false;
	}	
...
<meta name="VI60_defaultClientScript" content="VBScript">
   ...
   <frameset  CanDocUnloadNowInf= "YES" ROWS="0,*" border="0" framespacing="0">
        ...
        <frame NAME="WORKAREA" SRC="MCBranchAssignRuleDetails.asp?<%=Request.QueryString%>"   SCROLLING="NO" FRAMEBORDER="no" NORESIZE BORDER="0" framespacing="0">
	</frameset>
