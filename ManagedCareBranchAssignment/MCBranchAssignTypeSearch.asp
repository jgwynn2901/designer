...
<title>Managed Care Branch Assignment Type Search</title>
<link rel="stylesheet" type="text/css" href="..\FNSDESIGN.css">

<script ID="clientEventHandlersVBS" LANGUAGE="vbscript">

Sub BtnClear_onclick()
	document.all.SearchMCBATID.value = ""
...
Sub BtnSearch_onclick()
	'If document.all.SearchBATID.value = "" And document.all.SearchDescription.value = "" And _
...
<%	End If %>	
	...
	If document.all.SearchMCBATID.value <> "" Or document.all.SearchDescription.value <> "" Or _
...
Sub PostTo(strURL)
	...
	curMCBATID = Parent.frames("WORKAREA").GetMCBATID
	temp = Split(curMCBATID, "||")
	If UBound(temp) >= 0 Then 
		document.all.MCBATID.value = temp(0)
	Else		
		document.all.MCBATID.value = ""
	End If	
	FrmSearch.action = "MCBranchAssignTypeDetails-f.asp"
...
<tr><td CLASS="GrpLabel" WIDTH="134" HEIGHT="10"><nobr>&nbsp;» Managed Care Branch Assignment Type Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="../Images/HelpIcon2.gif" STYLE="CURSOR:HAND" align=absmiddle title=Help OnClick='LaunchHelp("Welcome.htm")'></td>
...
<form Name="FrmSearch" METHOD="GET" ACTION="MCBranchAssignTypeSearchResults.asp" TARGET="WORKAREA">
...
<td>
 <table>
	...
	<tr>
	<td CLASS="LABEL">Managed Care Branch Assignment Type ID:<br><input CLASS="LABEL" tabindex=5 TYPE="TEXT" NAME="SearchMCBATID" VALUE="<%=Request.QueryString("SearchMCBATID")%>"></td>
	</tr>
 </table>
</td>			
