...
'***************************************************************
'General purpose: Allows for search into claim class rules 
'
'$History: ClaimClassAssignRuleSearch.asp $ 
'* 
'* *****************  Version 1  *****************
...
<title>Claim Class Assignment Rule Search</title>
...
<%		End If 
	...
	If document.all.SearchCARID.value <> "" Or _
...
Sub PostTo(strURL)
	...
	End If	
	FrmSearch.action = "claimclassassignRuleDetails-f.asp"
...
<tr><td CLASS="GrpLabel" WIDTH="134" HEIGHT="10"><nobr>&nbsp;» Claim Class Assignment Rule Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="../Images/HelpIcon2.gif" STYLE="CURSOR:HAND" align=absmiddle title=Help OnClick='LaunchHelp("Welcome.htm")'></td>
...
<form Name="FrmSearch" METHOD="GET" ACTION="claimclassassignRuleSearchResults.asp" TARGET="WORKAREA">
<input type="hidden" NAME="MODE" value="<%=Request.QueryString("MODE")%>">
<input type="hidden" NAME="CARID" value="<%=Request.QueryString("CARID")%>" ID="Hidden1">
...
<td>
 <table>
	...
	<tr>
	<td CLASS="LABEL">Sequence:<br><input CLASS="LABEL" tabindex=6  size="12" TYPE="TEXT" NAME="SearchSequence" VALUE="<%=Request.QueryString("SearchSequence")%>"></td>
	<td CLASS="LABEL">Weight:<br><input CLASS="LABEL" tabindex=6  size="12" TYPE="TEXT" NAME="SearchWeight" VALUE="<%=Request.QueryString("SearchWeight")%>" ID="Text1"></td>
	<td CLASS="LABEL">Class:<br><input CLASS="LABEL" tabindex=6  size="12" TYPE="TEXT" NAME="SearchClass" VALUE="<%=Request.QueryString("SearchClass")%>" ID="Text2"></td>
	<td CLASS="LABEL"  colspan=3>Claim Class Assignment ID:<br><input CLASS="LABEL" tabindex=6  size="12" TYPE="TEXT" NAME="SearchCARID" VALUE="<%=Request.QueryString("SearchCARID")%>" ID="Text3"></td>
	</tr> 
 </table>
</td>			
