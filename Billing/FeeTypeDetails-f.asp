...
Function GetFIDName
	GetFIDName = frames("WORKAREA").GetFIDName
End Function
...
<meta name="VI60_defaultClientScript" content="VBScript">
   ...
   <frameset  CanDocUnloadNowInf= "YES" ROWS="0,*" border="0" framespacing="0">
        ...
        <frame NAME="WORKAREA" SRC="FeeTypeDetails.asp?<%=Request.QueryString%>"   SCROLLING="NO" FRAMEBORDER="no" NORESIZE BORDER="0" framespacing="0">
	</frameset>
</html>