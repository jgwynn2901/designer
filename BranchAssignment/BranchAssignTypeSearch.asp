...
<title>Branch Assignment Type Search</title>
<link rel="stylesheet" type="text/css" href="..\FNSDESIGN.css">

<script ID="clientEventHandlersVBS" LANGUAGE="vbscript">

Sub BtnClear_onclick()
	document.all.SearchBATID.value = ""
...
<%	End If %>	
	...
	If document.all.SearchBATID.value <> "" Or document.all.SearchDescription.value <> "" Or _
...
Sub PostTo(strURL)
	...
	curBATID = Parent.frames("WORKAREA").GetBATID
	temp = Split(curBATID, "||")
	If UBound(temp) >= 0 Then 
		document.all.BATID.value = temp(0)
	Else		
		document.all.BATID.value = ""
	End If	
	FrmSearch.action = "BranchAssignTypeDetails-f.asp"
...
<tr><td CLASS="GrpLabel" WIDTH="134" HEIGHT="10"><nobr>&nbsp;» Branch Assignment Type Search&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<IMG SRC="../Images/HelpIcon2.gif" STYLE="CURSOR:HAND" align=absmiddle title=Help OnClick='LaunchHelp("Welcome.htm")'></td>
...
<form Name="FrmSearch" METHOD="GET" ACTION="BranchAssignTypeSearchResults.asp" TARGET="WORKAREA">
...
<td>
 <table>
	...
	<tr>
	<td CLASS="LABEL">Branch Assignment Type ID:<br><input CLASS="LABEL" tabindex=5 TYPE="TEXT" NAME="SearchBATID" VALUE="<%=Request.QueryString("SearchBATID")%>"></td>
	</tr>
 </table>
</td>			
