...
Public Class COVBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "COVBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCOVBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As COVBillingSummaryFixed = New COVBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
