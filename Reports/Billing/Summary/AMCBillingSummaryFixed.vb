...
Public Class AMCBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "AMCBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAMCBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AMCBillingSummaryFixed = New AMCBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
