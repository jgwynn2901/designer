...
Public Class PrudenBillingSummary
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "PrudenBillingSummary.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPrudenBillingSummary
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PrudenBillingSummary = New PrudenBillingSummary
        rpt.Site = Me.Site
        Return rpt
    End Function
