...
Public Class SAFBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SAFBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSAFBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SAFBillingSummaryFixed = New SAFBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
