...
Public Class BillingSummaryFixed
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "BillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillingSummaryFixed = New BillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
