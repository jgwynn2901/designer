...
Public Class KMPBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "KMPBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKMPBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KMPBillingSummaryFixed = New KMPBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
