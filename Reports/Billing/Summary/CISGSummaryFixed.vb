...
Module CISGSummaryFixed

    Sub getCISGPricing(ByRef oRpt As BillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
        ...
        'End If
        oConn.ConnectionString = "Data Source=cisg; user id=fnsowner;password=ctown_prod;Persist Security info=False;"
        'oConn.ConnectionString = "Data Source=fnsproduction; user id=fnsowner;password=ctown_prod;Persist Security info=False;"
        'oConn.ConnectionString = "User Id=fnsowner;Password=ctown_designer;Data Source=fnsba;"
        oConn.Open()
        ...
        ' If lIsCCE Then
        ' cSQ'L = cSQL & "AND CALL.ACCNT_HRCY_STEP_ID = " & cAHS_ID
        ' Else
