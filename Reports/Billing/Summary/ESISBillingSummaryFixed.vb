...
Public Class ESISBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "ESISBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedESISBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ESISBillingSummaryFixed = New ESISBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
