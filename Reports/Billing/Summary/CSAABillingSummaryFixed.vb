...
Public Class CSAABillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "CSAABillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCSAABillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CSAABillingSummaryFixed = New CSAABillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
