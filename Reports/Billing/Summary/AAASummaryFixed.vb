...
Module AAAsummaryFixed

    Sub getAAAClaimsFixedPricing(ByRef oRpt As AAABillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String, ByVal lIsCCE As Boolean)
        Dim cSQL As String
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As AAABillingSummaryFixed, _
