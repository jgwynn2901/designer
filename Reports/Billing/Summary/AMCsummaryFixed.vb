...
'FNS DESIGNER
'Client			:	ALL
'Script Date: 05/16/2011	By: Syed Waqas Ahmed Shah
...
Module AMCsummaryFixed

    Sub getClaimsFixedPricingAMC(ByRef oRpt As AMCBillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String, ByVal lIsCCE As Boolean)
        Dim cSQL As String
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As AMCBillingSummaryFixed, _
