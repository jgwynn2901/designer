...
Public Class NBICBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "NBICBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedNBICBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As NBICBillingSummaryFixed = New NBICBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
