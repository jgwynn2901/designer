'--------------------------------------------------------------------------------------------------------------------*/
'WORK REQUEST – MROU-3087
'FNS DESIGNER/
'Client			:	EVR
'Script Date: 02/05/2006	By: Abu/Subhalakshmi
'Requirement		: 	Everest:Add Client Code & Client's Name to FNS Designer for Billing Purposes 
'*/
'---------------------------------------------------------------------------------------------------------------------->
...
Module EVRBillingSummary

    Sub getClaimsEVR(ByRef oRpt As EVRBillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
        ...
        SqlStrBuilder.Append(" AND call.client_hrcy_step_id = 155")
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As EVRBillingSummaryFixed, _
