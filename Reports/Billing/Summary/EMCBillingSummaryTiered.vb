...
Public Class EMCBillingSummaryTiered
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "EMCBillingSummaryTiered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEMCBillingSummaryTiered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EMCBillingSummaryTiered = New EMCBillingSummaryTiered
        rpt.Site = Me.Site
        Return rpt
    End Function
