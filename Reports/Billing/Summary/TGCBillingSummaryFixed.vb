...
Public Class TGCBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "TGCBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTGCBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TGCBillingSummaryFixed = New TGCBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
