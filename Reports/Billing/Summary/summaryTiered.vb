...
Module summaryTiered

    Sub getClaimsTieredPricing(ByRef oRpt As BillingSummaryTiered, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
