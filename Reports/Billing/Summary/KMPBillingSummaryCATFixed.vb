...
Public Class KMPBillingSummaryCATFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "KMPBillingSummaryCATFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedKMPBillingSummaryCATFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As KMPBillingSummaryCATFixed = New KMPBillingSummaryCATFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
