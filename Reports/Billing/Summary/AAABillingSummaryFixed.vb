...
Public Class AAABillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "AAABillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAAABillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AAABillingSummaryFixed = New AAABillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
