...
Public Class GBSBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "GBSBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedGBSBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As GBSBillingSummaryFixed = New GBSBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
