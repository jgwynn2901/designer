...
Public Class BillingSummaryTiered
    ...
    Public Overrides Property ResourceName As [String]
        Get
            Return "BillingSummaryTiered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedBillingSummaryTiered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As BillingSummaryTiered = New BillingSummaryTiered
        rpt.Site = Me.Site
        Return rpt
    End Function
