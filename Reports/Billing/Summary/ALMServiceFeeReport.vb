...
Module ALMServiceFeeReport

    Sub getALMBillingSummaryReport(ByRef oRpt As ALMBillingSummary, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String, ByVal lIsCCE As Boolean)
        Dim cSQL As String
            ...
            Do
                ...
                Select Case CType(oReader.GetValue(oReader.GetOrdinal("LOB_CD")), String)
                    Case "PAU"
                        ...
                        getFees(oConn, oRpt, cAHS_ID, "PAU", "F", nFAX_FEE, "nPAUPriceF")
                    Case "CAU"
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As ALMBillingSummary, _
