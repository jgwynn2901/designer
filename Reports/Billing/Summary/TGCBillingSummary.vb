...
Module TGCBillingSummary

    Sub getClaimsTGC(ByRef oRpt As TGCBillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
        ...
        SqlStrBuilder.Append(" AND call.client_hrcy_step_id = 190")
        ...
        SqlStrBuilder.Append(" AND CALL_CALLER.CALL_ID = CALL.CALL_ID + 0 ")
        SqlStrBuilder.Append(" AND CALL.CALL_ID = CALL_CLAIM.CALL_ID ")
        SqlStrBuilder.Append(" AND CALL_CALLER.CALLER_TYPE = 'WEB' ")
        SqlStrBuilder.Append(" AND call.client_hrcy_step_id = 190")
        SqlStrBuilder.Append("  Group by LOB_CD")
        strSQL = SqlStrBuilder.ToString
        oCmd.CommandText = SqlStrBuilder.ToString
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As TGCBillingSummaryFixed, _
