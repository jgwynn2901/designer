...
Public Class HMLBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "HMLBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedHMLBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As HMLBillingSummaryFixed = New HMLBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
