...
Public Class RTWBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "RTWBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRTWBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RTWBillingSummaryFixed = New RTWBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
