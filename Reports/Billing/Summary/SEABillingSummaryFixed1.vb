...
Public Class SEABillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SEABillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSEABillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SEABillingSummaryFixed = New SEABillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
