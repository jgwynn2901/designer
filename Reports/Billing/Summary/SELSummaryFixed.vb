...
Module SELSummaryFixed

    Sub getSELClaimsFixedPricing(ByRef oRpt As SELBillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String, ByVal lIsCCE As Boolean)
        Dim cSQL As String
        ...
        If oReader.HasRows Then
            Do
                ...
                End Select
                If Not lIsINFO Then
                    If Not IsNothing(oParamFld) Then
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As SELBillingSummaryFixed, _
