...
Public Class TGCASPBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "TGCASPBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedTGCASPBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As TGCASPBillingSummaryFixed = New TGCASPBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
