...
Public Class SELBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SELBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSELBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SELBillingSummaryFixed = New SELBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
