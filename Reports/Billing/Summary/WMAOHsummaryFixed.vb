...
Module WMAOHsummary
    Sub getClaimsWMAOH(ByRef oRpt As BillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportDate As String)
        Dim cSQL As String
        ...
        SqlStrBuilder.Append(" and CCL.BENEFIT_STATE ='OH'")
