...
Module summaryMGCNoConfirmation

    Sub getMGCClaimsNoConfirmation(ByRef oRpt As BillingSummaryTiered, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
        ...
        nTotalClaimsNOConfirm = 0
        oReader.Read()
        If oReader.HasRows Then
            nTotalClaimsNOConfirm = CInt(oReader.GetValue(oReader.GetOrdinal("totalCalls")))
        End If
        oReader.Close()
        '   get INF claims
