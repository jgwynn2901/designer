...
Module SHPRsummary
    Sub getClaimsSHPR(ByRef oRpt As BillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportDate As String)
        Dim cSQL As String
        ...
        dRepEnd = DateAdd(DateInterval.Month, 1, dRepStart)
        ...
        SqlStrBuilder.Append(" and call_account.LOCATION_CODE ='001406'")
        ' SqlStrBuilder.Append(" and call_claim.BENEFIT_STATE ='OH'")
        ...
        '************************ get INF claims ******************************
        SqlStrBuilder = New System.Text.StringBuilder("")
        SqlStrBuilder.Append(" Select count(*) as nTotal From CALL C, CALL_CLAIM CCL,x_call_claim xcc  ")
        SqlStrBuilder.Append(" Where C.CALL_ID = CCL.CALL_ID(+) ")
        SqlStrBuilder.Append(" AND CCL.CALL_CLAIM_ID = xcc.CALL_CLAIM_ID ")
        ...
        SqlStrBuilder.Append(" and xcc.FIELD ='SUN_INFO_FLG'")
        SqlStrBuilder.Append(" and xcc.VALUE ='Y'")
