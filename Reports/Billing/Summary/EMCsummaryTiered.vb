...
Module summaryTieredEMC

    Sub getClaimsTieredPricingEMC(ByRef oRpt As EMCBillingSummaryTiered, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
    ...
    Private Sub getTieredFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As EMCBillingSummaryTiered, _
