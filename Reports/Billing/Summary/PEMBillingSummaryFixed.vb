...
Public Class PEMBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "PEMBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedPEMBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As PEMBillingSummaryFixed = New PEMBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
