...
Public Class AFFBillingSummaryTiered
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "AFFBillingSummaryTiered.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAFFBillingSummaryTiered
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AFFBillingSummaryTiered = New AFFBillingSummaryTiered
        rpt.Site = Me.Site
        Return rpt
    End Function
