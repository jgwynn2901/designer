...
Module PEMBillingSummary

    Sub getClaimsPEM(ByRef oRpt As PEMBillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String)
        Dim cSQL As String
        ...
        SqlStrBuilder.Append(" AND call.client_hrcy_step_id = 615")
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As PEMBillingSummaryFixed, _
