...
Module NBICsummaryFixed

    Sub getNBICClaimsFixedPricing(ByRef oRpt As NBICBillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String, ByVal lIsCCE As Boolean)
        Dim cSQL As String
            ...
            Do
                ...
                Select Case oReader.GetValue(oReader.GetOrdinal("LOB_CD"))
                    ...
                    Case "PPR"
                        ...
                        getServiceFees(oConn, oRpt, cAHS_ID, "PPR", "C", nSERVICE_FEE, "nPPRPriceC", CInt(oReader.GetValue(oReader.GetOrdinal("nTotal"))))
                    Case "CAU"
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As NBICBillingSummaryFixed, _
    ...
    Sub getServiceFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As NBICBillingSummaryFixed, _
                ByVal cAHS_ID As String, _
                ByVal cLOB As String, _
                ByVal cCallType As String, _
        ...
        cSQL = "Select FEE_AMOUNT From FEE Where ACCNT_HRCY_STEP_ID = " & cAHS_ID & _
                ...
                "AND (" & iCallCount & " >= Begin_Call_Range and (" & iCallCount & " <= End_Call_Range or End_Call_Range = 0))"
        oCmd.Connection = oConn
        oCmd.CommandText = cSQL
        oReader = oCmd.ExecuteReader()
        oReader.Read()
