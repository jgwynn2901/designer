...
Public Class EVRBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "EVRBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedEVRBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As EVRBillingSummaryFixed = New EVRBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
