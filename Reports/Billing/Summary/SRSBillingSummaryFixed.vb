...
Public Class SRSBillingSummaryFixed
    ...
    Public Overrides Property ResourceName As String
        Get
            Return "SRSBillingSummaryFixed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedSRSBillingSummaryFixed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As SRSBillingSummaryFixed = New SRSBillingSummaryFixed
        rpt.Site = Me.Site
        Return rpt
    End Function
