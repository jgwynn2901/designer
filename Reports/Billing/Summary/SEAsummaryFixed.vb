...
Module SEAsummaryFixed

    Sub getSEAClaimsFixedPricing(ByRef oRpt As SEABillingSummaryFixed, ByVal cAHS_ID As String, ByVal cClient As String, ByVal cReportStartDate As String, ByVal cReportEndDate As String, ByVal lIsCCE As Boolean)
        Dim cSQL As String
        ...
        cSQL = "Select LOB_CD, count(*) as nTotal From CALL, CALL_CALLER ,CALL_CLAIM " & _
             ...
             "AND CALL_CALLER.CALLER_TYPE NOT IN ('EMAIL','EML','E') " & _
        ...
        cSQL = "Select LOB_CD, count(*) as nTotal From CALL, CALL_CALLER " & _
             ...
             "AND STATUS = 'COMPLETED' " & _
             "AND CALL_CALLER.CALL_ID = CALL.CALL_ID + 0 " & _
             "AND CALL_CALLER.CALLER_TYPE IN('EMAIL','EML','E') " & _
             "AND CALL.CLIENT_HRCY_STEP_ID = " & cAHS_ID & " Group by LOB_CD"
        oCmd.CommandText = cSQL
        oReader = oCmd.ExecuteReader()
        oReader.Read()
        If oReader.HasRows Then
    ...
    Sub getFees(ByVal oConn As OracleConnection, _
                ByVal oRpt As SEABillingSummaryFixed, _
