...
Function GetOVID
	GetOVID = frames("WORKAREA").GetOVID
End Function
...
<meta name="VI60_defaultClientScript" content="VBScript">
   ...
   <frameset CanDocUnloadNowInf="YES" ROWS="0,*" border="0" framespacing="0">
        ...
        <frame NAME="WORKAREA" SRC="Attribute_Override_Details.asp?<%=Request.QueryString%>" SCROLLING="Auto" FRAMEBORDER="no" NORESIZE BORDER="0" framespacing="0">
	</frameset>
</html>